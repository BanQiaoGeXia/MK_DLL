...
//下划线型转驼峰型
char *DownLine2Camelback(const char *src)
{
...
//下划线型转帕斯卡型
char *DownLine2Pascal(const char *src)
{
	// char * hungary_test = "aaa_bb_ccc_ddd";
	if(src == NULL)
	{
...
//帕斯卡型转匈牙利型
char *Pascal2Hungary(const char *src)
{
	// char * hungary_test = "AaaBbCccDdd";
	if(src == NULL)
	{
...
//帕斯卡型转下划线型
char *Pascal2DownLine(const char *src)
{
	// char * hungary_test = "AaaBbCccDdd";
	if(src == NULL)
	{
...
//帕斯卡型转驼峰型
char *Pascal2Camelback(const char *src)
{
	// char * hungary_test = "AaaBbCccDdd";
	if(src == NULL)
	{
